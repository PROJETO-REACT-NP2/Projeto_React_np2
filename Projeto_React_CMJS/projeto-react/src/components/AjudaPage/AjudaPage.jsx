...
// Página de ajuda — explica o que significam os campos "Renda Mensal" e "Custos Mensais"
const AjudaPage = () => {
    const containerStyle = {
        maxWidth: '800px', margin: '40px auto', padding: '40px',
        backgroundColor: '#FFFFFF', borderRadius: '12px',
        boxShadow: '0 5px 15px rgba(0, 0, 0, 0.1)', color: '#05142e',
    };

    const titleStyle = { marginBottom: '30px', color: '#007284', textAlign: 'center' };

    const infoBoxStyle = {
        backgroundColor: '#F7FAFC', padding: '20px', marginBottom: '25px',
        borderRadius: '8px', borderLeft: '5px solid #667eea',
    };

    const infoBoxTitleStyle = { color: '#764ba2', marginTop: '0', marginBottom: '10px', fontSize: '1.3em' };

    const linkStyle = {
        textDecoration: 'none', display: 'inline-block', width: 'auto', padding: '12px 25px',
        borderRadius: '8px', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
        color: 'white', fontWeight: 'bold', transition: 'opacity 0.3s',
    };
